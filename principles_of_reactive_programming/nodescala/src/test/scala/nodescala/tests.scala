...
class NodeScalaSuite extends FunSuite {
  ...
  test("A Future") {
    val f = Future {1}
    assert(Await.result(f, 1 nanos) == 1)
  }
  ...
  test("All futures should complete") {
    val f1 = Future {
      System.out.println("Future 1 starts")
      Thread.sleep(1000)
      System.out.println("Future 1 finishes")
      1
    }
    val f2 = Future {
      System.out.println("Future 2 starts")
      Thread.sleep(1000)
      System.out.println("Future 2 finishes")
      2
    }
    val f3 = Future {
      System.out.println("Future 3 starts")
      Thread.sleep(1000)
      System.out.println("Future 3 finishes")
      3
    }
    System.out.println("Future all starts")
    val all = Future.all(List(f1, f2, f3))
    assert(Await.result(all, 1 second) == List(1, 2, 3))
    /* 
    Thread.sleep(1000)
    all onSuccess {
    case List(1,2,3) => System.out.println("Future all finishes")
    } */
  }
